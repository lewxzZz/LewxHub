...
local Window = redzlib:MakeWindow({
    Title = "Lewx Hub : Blox Fruit",
    SubTitle = "by real_lewx",
    SaveFolder = "lewxcuto.json"
})
...
Tabs.Info:AddDiscordInvite({
	Title = "Lewx Hub | Community",
	Description = "Dang Cap Dep Zai",
	Banner = "rbxassetid://92398444264781", 
	Logo = "rbxassetid://92398444264781",
	Invite = "https://discord.gg/zjj4GdkK3W",
	Members = 363636, 
	Online = 0, 
})
...
Window:Notify({
  ...
  Image = "rbxassetid://92398444264781",
  Duration = 5
})